...
The second model is ruled out as its highest RMSE than the others. And
although the RMSE of the first model is similar with the third one, the
first one has a much lower complexity.
...
the estimate of r squared is somewhere around 0.915.
...
*r̂*<sup>2</sup> is (0.893, 0.927) and (0.853, 0.894) for
